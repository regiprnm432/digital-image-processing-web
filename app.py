...
def puzzle():
    ...
    image_processing.puzzle("static/img/img_now.jpg", puzzle_size=(size, size), padding=10)
    return render_template("uploaded.html", file_path="img/img_now.jpg")

@app.route("/randomize_puzzle", methods=["POST"])
@nocache
...
def upload_img():
    ...
    return render_template("quiz.html", file_path="img/img_now.jpg")
